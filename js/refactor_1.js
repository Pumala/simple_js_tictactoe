$(document).ready(function() {
  ...
  function compHuman() {
    ...
    while (compTurn && !gameOver) {
      ...
      if ($($("td")[randomIndex]).text() === "" && compTurn) {
        ...
        setTimeout(function() {
          ...
          humanTurn = true;
          counter = 0;
          console.log("HUman trial!!");
          console.log("comp, game, human: " + compTurn + gameOver + humanTurn);
        }, 2000);
        compTurn = false;
        console.log("I waited too long!");
        break;
      }
    }
    console.log("I am waiting for you!!!!!");
    console.log("222comp, game, human: " + compTurn + gameOver + humanTurn);
    if (!compTurn && !gameOver && counter === 0) {
      console.log("I am here!!!");
      console.log("HUman turn: " + humanTurn);
      if (counter === 0 && humanTurn) {
        $("td").click(function() {
          if ($(this).text() === "" && counter === 0 && !compTurn) {
